...
def create_cost(subscription_plan):
    ...
    return test_forms.create_cost(plan=subscription_plan, period=1, unit=models.MONTH,
                                  cost='1.00'
                                  )
...
def test_manager_process_expired_multiple_different_groups(django_user_model):
    ...
    cost_1 = create_cost(subscription_plan_1)
    ...
    cost_2 = create_cost(subscription_plan_2)
    ...
    user_subscription_1 = models.UserSubscription.objects.get(id=user_subscription_1_id)
    user_subscription_2 = models.UserSubscription.objects.get(id=user_subscription_2_id)
